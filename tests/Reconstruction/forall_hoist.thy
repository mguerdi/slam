...
ML_val \<open>
  val premise = mkh @{prop "A \<Longrightarrow> B (\<forall>x. (f :: 'a \<Rightarrow> 'b \<Rightarrow> bool) x c) = B' \<Longrightarrow> D \<Longrightarrow> False"}
...
ML_val \<open>
  val premise = mkh @{term_schem "A ?y \<Longrightarrow> B (\<forall>x. (f :: 'a \<Rightarrow> 'b \<Rightarrow> bool) x c) = B' \<Longrightarrow> False"}
  val expected = mkh @{term_schem
...
ML_val \<open>
  val premise = mkh @{term_schem "A ?fresh_x \<Longrightarrow> B (\<forall>x. (f :: 'a \<Rightarrow> 'b \<Rightarrow> bool) x c) = B' \<Longrightarrow> False"}
  val expected = mkh @{term_schem
...
ML_val \<open>
  val premise = mkh @{term_schem "B (\<forall>x. (f :: ?'a \<Rightarrow> 'b \<Rightarrow> bool) x c) = B' \<Longrightarrow> False"}
  val expected = mkh @{term_schem
