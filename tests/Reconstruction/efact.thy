...
ML_val \<open>
  ...
  val expected = mk @{prop "(u :: 'a) \<noteq> v' \<Longrightarrow> v = v' \<Longrightarrow> \<not>C' \<Longrightarrow> False"}
...
ML_val \<open>
  ...
  val expected_four_lits = mk @{prop "(u :: 'a) \<noteq> v' \<Longrightarrow> v = v' \<Longrightarrow> A \<Longrightarrow> B \<Longrightarrow> False"}
...
ML_val \<open>
  ...
  val expected3 = mk @{prop "(u :: 'a) \<noteq> v' \<Longrightarrow> v = v' \<Longrightarrow> \<not>C' \<Longrightarrow> False"}
